  ...
  return (
    <section className="blog-social blog-social--border-top mt-5 py-3">
      <div className="blog-social__header h4">
        Like what you read? Give me an applause.
      </div>
      <p className="ui-body u-marginBottom20 u-textColorDark u-fontSize16">
        From a quick cheer to a standing ovation, clap to show how much you enjoyed this blog.
      </p>
      <div className="d-flex align-items">
        <span className="blog-social__clap-wrapper border rounded-circle" onClick={e => onClap(e)}>
          {
            !isClap ?
            <svg className="blog-social__clap-icon" width="33" height="33" viewBox="0 0 33 33">
            ...
            :
            <svg className="blog-social__clap-icon--active" width="33" height="33" viewBox="0 0 33 33">
              <g fillRule="evenodd">
